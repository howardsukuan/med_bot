...
departmentDICT = {
    ...
    "肝膽腸胃科": ["肚子", "腸胃", "胃","腹脹","腹鳴","腹瀉","大便不規則","食慾不振","胃酸","胃潰瘍","黑便","吐血","膚色變黃","B型肝炎帶原者","C型肝炎帶原者","肝機能異常","肝膽結石"],
    ...
    "內分泌科": ["賀爾蒙","甲狀腺疾病","糖尿病","肥胖","腦下垂體病變","腎上腺","副甲狀腺","高尿酸","代謝異常"],
    "神經內科": ["神經內", "麻痺"],
    ...
    "復健科":["骨骼肌肉","腰酸背痛","關節","運動傷害","中風","脊椎","腦性麻痺","心肺復健"],
    
    }


#FindDepartment危急情況字典
emergencyLIST = ["大量出血","昏迷","失去意識","沒有心跳","血流不止","停止呼吸", "暈倒","噴血","暈倒"]
otherLIST = ["狗", "貓", "鳥", "鼠"]